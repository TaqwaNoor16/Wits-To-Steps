...
func start_sneaker_after_note_offset() -> void:
	...
	# Uses Level 2's own NoteSpawner beat_offset.
	# Your Level 2 offset can stay 0.07.
...
func _process(delta: float) -> void:
	...
	# Sneaker cannot score until notes begin.
